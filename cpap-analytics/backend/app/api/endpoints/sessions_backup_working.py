...
async def get_analytics(
    ...
    """Return 30-day mock analytics data"""
    return {
        'summary': {
            'total_sessions': 30,
            'avg_ahi': 4.5,
        ...
        'recent_sessions': [
            {'id': 1, 'user_id': current_user.id, 'date': '2025-05-28', 'duration_hours': 7.8, 'ahi': 4.2, 'mask_leak': 4.5, 'pressure_avg': 12.0, 'pressure_95': 14.0, 'quality_score': 87.0, 'central_apneas': 2, 'obstructive_apneas': 5, 'hypopneas': 8, 'created_at': '2025-05-28T23:00:00'},
